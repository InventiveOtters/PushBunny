...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NotificationResponse")))
@interface LibraryNotificationResponse : LibraryBase
- (instancetype)initWithVariantId:(NSString *)variantId resolvedMessage:(NSString *)resolvedMessage __attribute__((swift_name("init(variantId:resolvedMessage:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) LibraryNotificationResponseCompanion *companion __attribute__((swift_name("companion")));
- (LibraryNotificationResponse *)doCopyVariantId:(NSString *)variantId resolvedMessage:(NSString *)resolvedMessage __attribute__((swift_name("doCopy(variantId:resolvedMessage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="resolved_message")
*/
@property (readonly) NSString *resolvedMessage __attribute__((swift_name("resolvedMessage")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="variant_id")
*/
@property (readonly) NSString *variantId __attribute__((swift_name("variantId")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NotificationResponse.Companion")))
@interface LibraryNotificationResponseCompanion : LibraryBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) LibraryNotificationResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<LibraryKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (id<LibraryKotlinx_serialization_coreEncoder>)encodeInlineDescriptor:(id<LibraryKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("encodeInline(descriptor:)")));
...
- (id<LibraryKotlinx_serialization_coreDecoder>)decodeInlineDescriptor:(id<LibraryKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("decodeInline(descriptor:)")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id<LibraryKotlinx_serialization_coreKSerializer> _Nullable)getContextualKClass:(id<LibraryKotlinKClass>)kClass typeArgumentsSerializers:(NSArray<id<LibraryKotlinx_serialization_coreKSerializer>> *)typeArgumentsSerializers __attribute__((swift_name("getContextual(kClass:typeArgumentsSerializers:)")));
...
@required
- (void)contextualKClass:(id<LibraryKotlinKClass>)kClass provider:(id<LibraryKotlinx_serialization_coreKSerializer> (^)(NSArray<id<LibraryKotlinx_serialization_coreKSerializer>> *))provider __attribute__((swift_name("contextual(kClass:provider:)")));
...
- (void)polymorphicDefaultBaseClass:(id<LibraryKotlinKClass>)baseClass defaultDeserializerProvider:(id<LibraryKotlinx_serialization_coreDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultDeserializerProvider __attribute__((swift_name("polymorphicDefault(baseClass:defaultDeserializerProvider:)"))) __attribute__((deprecated("Deprecated in favor of function with more precise name: polymorphicDefaultDeserializer")));
- (void)polymorphicDefaultDeserializerBaseClass:(id<LibraryKotlinKClass>)baseClass defaultDeserializerProvider:(id<LibraryKotlinx_serialization_coreDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultDeserializerProvider __attribute__((swift_name("polymorphicDefaultDeserializer(baseClass:defaultDeserializerProvider:)")));
- (void)polymorphicDefaultSerializerBaseClass:(id<LibraryKotlinKClass>)baseClass defaultSerializerProvider:(id<LibraryKotlinx_serialization_coreSerializationStrategy> _Nullable (^)(id))defaultSerializerProvider __attribute__((swift_name("polymorphicDefaultSerializer(baseClass:defaultSerializerProvider:)")));
@end
